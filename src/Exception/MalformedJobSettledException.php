 ...
 * being replayed forever once its reservation is reclaimed, since the
 * same bytes fail the same way on every retry. QueueWorker catches this
 * specifically, logs it, and moves on; a transport failure is a
 * different type and still stops the worker.
 */
